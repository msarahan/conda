...
class Solver(object):
    ...
    def _post_sat_handling(self, ssc):
        ...
        if ssc.deps_modifier == DepsModifier.NO_DEPS:
            ...
            specs_to_add_names = set(spec.name for spec in self.specs_to_add)
            update_names = set()
            ...
            ssc.solution_precs = ssc.r.solve(final_environment_specs)

            if ssc.deps_modifier == DepsModifier.ONLY_DEPS:
